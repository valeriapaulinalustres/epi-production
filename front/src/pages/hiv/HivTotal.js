...
function HivTotal() {
  ...
  const notificadosHivEstablecimientoCarga = [
    numeroTotalGeneralHivMoron,
    numeroTotalGeneralHivNoMoron,
  ];
    ...
    <div className='totalesGraphs-container'>
      <div className='totales-page-container'>
        <div className='recuadro naranja'>
          ...
          <p className='totalNumber'>{numeroTotalGeneralNotificadosHiv}</p>
        </div>
        <div className='recuadro salmon'>
          Confirmados:
          <p className='totalNumber'>{numeroConfirmadosTotalGeneralHiv}</p>
        </div>
        <div className='recuadro rosa'>
          Probables:
          <p className='totalNumber'>{numeroProbablesTotalGeneralHiv}</p>
        </div>
        ...
        <div className='recuadro rosa'>
          Expuesto perinatal:
          <p className='totalNumber'>{numeroTotalNotificadosHivPerinatal}</p>
        </div>
        <div className='recuadro salmon'>
          Gestantes del total:
          <p className='totalNumber'>{numeroTotalNotificadosHivEmbarazo}</p>
        </div>
        <div className='recuadro lila'>
          Notificados por Morón:
          <p className='totalNumber'>{porcentajeNotificadosHivMoron}%</p>
        </div>
      </div>
